...
Medicine med1;
    ...
    private void searchbuttinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchbuttinActionPerformed
        ...
        for(Medicine en : ecoSystem.getMedicinedir().getMedicineList()){
            ...
            {
                jtype.setText(en.getType());
                jdedicated.setText(String.valueOf(en.getDedicatedto()));
                jform.setText(en.getKind());
    ...
    private void jupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jupdateActionPerformed
        ...
        for(Medicine en : ecoSystem.getMedicinedir().getMedicineList()){
            if(med.getSelectedItem().equals(en.getMedicineName()))
            {
                en.setType(jtype.getText());
                en.setDedicatedto(jdedicated.getText());
                en.setKind(jform.getText());
